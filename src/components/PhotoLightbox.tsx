    ...
    <>
      ...
      {active !== null && (
        <div className="photo-lightbox" role="dialog" aria-modal="true" aria-label="Photo viewer">
          ...
          <button className="photo-lightbox-nav photo-lightbox-nav--prev" type="button" aria-label="Previous photo" onClick={previous}>
            <i className="ti ti-chevron-left" aria-hidden="true" />
          </button>
          <img className="photo-lightbox-image" src={photos[active].url} alt={photos[active].alt} />
          <button className="photo-lightbox-nav photo-lightbox-nav--next" type="button" aria-label="Next photo" onClick={next}>
