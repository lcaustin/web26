    ...
    <div className="resource-section">
      <div className="wrap">
        ...
        <div className="resource-grid">
          {list.map((item) => (
            <a key={item.id} href={item.href} className="resource-tile" style={{ textDecoration: 'none', display: 'block' }} {...(/^https?:\/\//.test(item.href) ? { target: '_blank', rel: 'noopener noreferrer' } : {})}>
